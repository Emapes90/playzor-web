...
export default function Locations() {
  return (
    <section
      id="locations"
      aria-label="Playzor Global Server Locations"
      className="py-16 sm:py-24 bg-black border-y border-white/5"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto text-sm sm:text-base">
            Low latency game server nodes deployed in India (Mumbai) and
            Singapore for the best ping.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          ...
          >
            <div className="w-10 h-7 sm:w-12 sm:h-8 relative overflow-hidden rounded shadow-sm ring-1 ring-white/10 transition-all duration-500 shrink-0">
              ...
              <svg viewBox="0 0 225 150" className="w-full h-full object-cover">
                ...
                <path
                  fill="#fff"
                  d="M93.75,37.5 L66.5625,23.4375 L66.5625,51.5625 L93.75,37.5 M50.625,19.6875 A17.8125,17.8125 0 0,1 50.625,55.3125 A21.5625,21.5625 0 1,0 50.625,19.6875"
                />
              </svg>
            </div>
          ...
          >
            <div className="absolute -top-2.5 sm:-top-3 right-2 sm:right-4 bg-red-500/10 border border-red-500/20 backdrop-blur-md px-2 sm:px-3 py-0.5 sm:py-1 rounded-full flex items-center gap-1 sm:gap-1.5">
              ...
              <span className="text-red-500 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider">
                Unavailable
              </span>
            </div>
            ...
            <div className="w-10 h-7 sm:w-12 sm:h-8 relative overflow-hidden rounded shadow-sm ring-1 ring-white/10 transition-all duration-500 shrink-0">
              ...
              <svg viewBox="0 0 900 600" className="w-full h-full object-cover">
                ...
                <path
                  fill="#fff"
                  d="M450,300 l-26.6,-48.6 15.6,24.6 -28.2,-15.6 26.6,48.6 -15.6,-24.6 28.2,15.6 z M450,300 l48.6,-26.6 -24.6,15.6 15.6,-28.2 -48.6,26.6 24.6,-15.6 -15.6,28.2 z M450,300 l26.6,48.6 -15.6,-24.6 28.2,15.6 -26.6,-48.6 15.6,24.6 -28.2,-15.6 z M450,300 l-48.6,26.6 24.6,-15.6 -15.6,28.2 48.6,-26.6 -24.6,15.6 15.6,-28.2 z M450,300 l-26.6,-48.6 15.6,24.6 -28.2,-15.6 26.6,48.6 -15.6,-24.6 28.2,15.6 z"
                  transform="scale(0.7) translate(190, 130)"
                />
                <circle
                  cx="450"
                  cy="300"
                ...
                <path
                  d="M450 340 L430 390 L400 350 L350 360 L380 320 L340 290 L390 280 L400 230 L430 270 L480 250 L460 300 L510 320 L460 340 Z"
                  fill="white"
                  transform="translate(0, -20) scale(0.6) translate(300, 200)"
                />
              </svg>
            </div>

            <div className="flex flex-col">
              <h3 className="text-sm sm:text-lg font-bold text-zinc-400">
                Hong Kong, CN
              </h3>
              <div className="flex items-center gap-1.5 sm:gap-2 mt-1 justify-center sm:justify-start">
